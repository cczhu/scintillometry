...
from ...fourier import FFTBase, NumpyFFT, PyfftwFFT
...
#         fft = FFTClass(complex_data=False, )
#         #


# Can test repr just by checking if repr includes something.